...
public class BlockItemRegistry {
    ...
    public static final Item TATAMI_WAXED = registerItem("tatami_waxed",
            new BlockItem(BlockRegistry.TATAMI_WAXED, SakuraFabric.defaultItemProperties()));
    public static final Item TATAMI_SLAB_WAXED = registerItem("tatami_slab_waxed",
            new BlockItem(BlockRegistry.TATAMI_SLAB_WAXED, SakuraFabric.defaultItemProperties()));
