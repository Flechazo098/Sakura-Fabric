...
import com.flechazo.sakura.block.crops.RiceCrop;
import com.flechazo.sakura.block.crops.RiceCropRoot;
import com.flechazo.sakura.block.foods.NabeBlock;
...
import com.flechazo.sakura.level.tree.MapleTreeGrower;
import com.flechazo.sakura.level.tree.SakuraTreeFeatures;
import com.flechazo.sakura.level.tree.SakuraTreeGrower;
...
public class BlockRegistry {
    ...
    private static <T extends Block> T registerBlock(String name, T block) {
        T registeredBlock = Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(SakuraFabric.MODID, name), block);
        BLOCKS.add(registeredBlock); // 将注册的方块添加到集合中
