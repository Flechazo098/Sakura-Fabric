...
//    public static final TagKey<Item> COOKIE_MATCHA = TagUtils.forgeItemTag("cookies/matcha");
    ...
    public static final TagKey<Item> RICE = TagUtils.modItemTag(SakuraFabric.MODID, "rice");
    public static final TagKey<Item> RICE_BROWN = TagUtils.modItemTag(SakuraFabric.MODID, "rice/brown");
    public static final TagKey<Item> RICE_RICE = TagUtils.modItemTag(SakuraFabric.MODID, "rice/rice");
...
//    public static final TagKey<Item> PASTA_PASTA = TagUtils.forgeItemTag("pasta/pasta");
    ...
    public static final TagKey<Item> FISHCAKE = TagUtils.modItemTag(SakuraFabric.MODID, "fishcake");
