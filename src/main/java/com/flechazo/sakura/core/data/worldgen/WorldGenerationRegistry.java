package com.flechazo.sakura.core.data.worldgen;
...
public class WorldGenerationRegistry {
    ...
    public static final ConfiguredFeature<?, ?> FEATURE_PATCH_BAMBOOSHOOT = new ConfiguredFeature<>(Feature.FLOWER, new RandomPatchConfiguration(
            ...
            new NormalNoise.NoiseParameters(0, 1.0), 0.005F, -0.8F, 0.33333334F, BlockRegistry.BAMBOOSHOOT.defaultBlockState(),
            List.of(BlockRegistry.BAMBOOSHOOT.defaultBlockState()),
            List.of(BlockRegistry.BAMBOOSHOOT.defaultBlockState()))))));
