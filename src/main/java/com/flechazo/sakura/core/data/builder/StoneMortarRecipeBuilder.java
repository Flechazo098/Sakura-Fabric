package com.flechazo.sakura.core.data.builder;
...
public class StoneMortarRecipeBuilder {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject json) {
            JsonObject recipeJson = RecipeSerializerRegistry.STONE_MORTAR_RECIPE_SERIALIZER.toJson(recipe);
        ...
        public RecipeSerializer<?> getType() {
            return RecipeSerializerRegistry.STONE_MORTAR_RECIPE_SERIALIZER;
        }
