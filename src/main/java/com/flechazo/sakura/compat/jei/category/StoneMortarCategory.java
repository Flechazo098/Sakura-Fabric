...
public class StoneMortarCategory implements IRecipeCategory<StoneMortarRecipe> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(SakuraFabric.MODID, "stone_mortar");
    ...
    public StoneMortarCategory(IGuiHelper helper) {
        ...
        ResourceLocation backgroundImage = new ResourceLocation(SakuraFabric.MODID, "textures/gui/stonemortar.png");
        background = helper.createDrawable(backgroundImage, 39, 13, 87, 62);
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(BlockRegistry.STONE_MORTAR));
